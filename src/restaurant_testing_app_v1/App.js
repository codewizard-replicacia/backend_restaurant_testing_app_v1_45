...
import ViewProductCategory from "./views/productCategory_details/productCategory_view";
import CreateProductCategoryForm from "./views/productCategory_details/productCategory_createForm";
import "./App.css";
          ...
          >
            ...
            <Routes>
              ...
              <Route path="/ProductCatalogues" element={<ProductCatalogueTable />} />
                            <Route path="/ProductCategories/view/:id" element={<ViewProductCategory />} />
              <Route path="/ProductCategories/create" element={<CreateProductCategoryForm />} />
            </Routes>
          </main>
        </SnackbarProvider>
      </BrowserRouter>
